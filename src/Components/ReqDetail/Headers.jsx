  ...
  !data ? null : (
    <section className={Styles["headers-container"]}>
      ...
      {data.headers.queryString && data.headers.queryString.length ? (
        <HeaderInfo component={QueryString} data={data} eventKey="queryString" isEncodeEnabled />
      ) : null}
      {data.headers.postData && data.headers.postData.params && (
        <HeaderInfo component={FormData} data={data} eventKey="formData" isEncodeEnabled />
      )}
